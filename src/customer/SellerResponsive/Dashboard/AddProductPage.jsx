  ...
  const sellerid = localStorage.getItem('sellerId');
   ...
   const handleSubmit = (e,status) => {
    ...
    const productData = {
      ...
      img: images[0] || "", 
      insurance: parseFloat(insuranceInput["مبلغ التأمين المطلوب"] || 0),  
                          ...
                          <div style={AddProductHeader.container}>
                              ...
                              {ProductAddressExpanded && (
                                ...
                                <form onSubmit={handleSubmit} style={addNewAddressStyles.container}>
                                                    ...
                                                    {cities.map((cityOption) => (
                                                      ...
                                                      style={{
                                                        ...
                                                        <button
                                                          ...
                                                          onChange={() => handleCitySelectProduct(cityOption)}
                                                        >
                                                          {cityOption}
                                                        </button>
                                                      </li>
                                        ...
                                        <button type="submit" style={addNewAddressStyles.submitButton}>
                                          اضافة العنوان
                                        </button>
                                </form>
                                </>
