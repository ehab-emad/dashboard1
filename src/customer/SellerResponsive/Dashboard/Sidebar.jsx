...
const {customerdata}=useSelector((state)=>state.customer_products)
...
dispatch(getCustomer(customerid))
  ...
  const handleLogout = () => {
    window.location.replace('https://trent.sa'); // Redirect to the specified URL on the current page
  };
    ...
    <>
      <SmallScreenNav style={{ display: 'flex', flexDirection: 'column', alignContent: 'center', justifyContent: 'space-between', width: '90%', margin: '0px auto' }}>
        ...
        <div style={styles.content}>
          <UserProfile
            name={customerdata.customername||"empty"}
            badge="عضوية المستأجر"
            avatar={customerdata.profileimage||"https://cdn.builder.io/api/v1/image/assets/TEMP/baffecfc9692f2dfc738996d25c51505e59c6ed6184688090ae0e2b176fb2014?placeholderIfAbsent=true&apiKey=2e2b2f636cc34221b980cbf747a16fe6"}
