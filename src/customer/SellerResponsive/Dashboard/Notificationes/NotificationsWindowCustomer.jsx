...
const NotificationsWindowCustomer = ({close, setCurrentPage,CountNotifications, notifications}) => {

  const {customer_notification} = useSelector((state ) => state.customer_stuff);
  console.log('all notifica,tions and tickets are', customer_notification)
  ...
  useEffect(() => {
    ...
    dispatch(CustomerNotifications(customerid))
  ...
  <div style={styles.overlay}>
    ...
    {customer_notification.length > 0 ?  <NotificationList notifications={customer_notification} setCurrentPage={setCurrentPage} close={close}/> : 
...
export default NotificationsWindowCustomer;