...
import { uploadIdImages, uploadIdImagesCustomer } from '../../../../../store/reducers/firebasefunctions'; // Import the uploadIdImages function
...
export default function UploadIDCustomer() {
  ...
  const handleImageUpload = async (event, setImageSrc, side) => {
    ...
    if (file) {
      try {
        ...
        const imageUrl = await uploadIdImagesCustomer(file, side, customerid); // Upload the file and get the URL
  ...
  return (
    <div style={styles.container}>
      ...
      <IdentityUploadCard
          ...
          imageSrc={customerby_Id?.idimages?.front || backImageSrc}        />
       <IdentityUploadCard
          ...
          imageSrc={customerby_Id?.idimages?.back || backImageSrc}        />
      </CardsContainer>
