...
import {
  SellerTransactions
} from '../../../store/reducers/sellerStuffReducer';
...
const Transactions = () => {
  ...
  const { seller_transactions } = useSelector((state) => state.seller_stuff);
  ...
  const transactionData = useMemo(() => {
    ...
    return seller_transactions || []; // Fallback to an empty array if seller_transactions is undefined
  }, [seller_transactions]);  
