...
import { updateSellerStatus } from '../../../../../store/reducers/firebasefunctions'; // Import the uploadIdImages function
...
`
const AccountDeactivationSeller = ({Sellerdata}) => {
 ...
 await   updateSellerStatus(sellerid)
...
export default AccountDeactivationSeller;