...
import { uploadProfileImage } from "../../../../../store/reducers/firebasefunctions";
...
const PersonalInfoCardSeller = ({Sellerdata}) => {
 

  const [profileImage, setProfileImage] = useState(Sellerdata.profileimage); // State to store the uploaded image
  ...
  const handleImageUpload = async (event) => {
    ...
    if (file) {
      ...
      try {
        ...
        const imageUrl = await uploadProfileImage(file, sellerid); // Pass the file and sellerId
  ...
  useEffect(() => {
    if (Sellerdata?.profileimage) {
      setProfileImage(Sellerdata.profileimage);
    }
...
export default PersonalInfoCardSeller;