...
import {updateSellerDetails} from  "../../../../../store/reducers/firebasefunctions.js"
import { useDispatch, useSelector } from "react-redux";
import { toast } from "react-toastify";
import { updateinfoseller } from "../../../../../store/reducers/sellerStuffReducer.js";
import { getSeller } from "../../../../../store/reducers/sellerProductsReducer.js";
...
const AccountDetailsSeller = ({Sellerdata}) => {
  
  const [selectedGender, setSelectedGender] = useState(Sellerdata.gender);
  const [verifycode , setverifycode] = useState(false);
  const [selectedName, setSelectedName] = useState(Sellerdata.sellername);
...
const dispatch=useDispatch()
  ...
  const handleSave = async () => {
      ...
      await dispatch(updateinfoseller({sellerid, sellerData}));
 ...
 // Call the update function
  ...
  // Use useEffect to enable/disable the save button
  // useEffect(() => {
  //   // const isActive = !!selectedPhone && !!selectedName && !!selectedEmail && !!selectedGender; // Check if all fields are filled
  //   // setSave(isActive); // Update button activation state
  // }, [selectedPhone, selectedName, selectedEmail,selectedGender]);
...
// useEffect(() => {
//   // const isActive =  !!selectedPhone || !!selectedName || !!selectedEmail ; // Check if the image is uploaded
//   // setSave(isActive); // Update button activation state
// }, [ selectedPhone, selectedName, selectedEmail]); // Include uploadedImage in the dependency array
    ...
    <div style={styles.container}>
      ...
      <div style={styles.fieldsContainer}>
        <Details style={styles.row}>
          ...
          <SettingsCardFieldCustomer
            label="الاسم"
            initialValue={Sellerdata?.sellername || ""} // Set the initial value here
            type='text'
...
export default AccountDetailsSeller;