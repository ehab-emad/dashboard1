...
import { deleteSellerAddress, updateSellerAddress } from '../../../../store/reducers/firebasefunctions';
...
const AddressesCardSeller = ({ address, toggleDefaultAddress, deleteAddress}) => {
...
const dispatch=useDispatch()
  ...
  const editaddress = async(id,updatedData) => {
    ...
    await updateSellerAddress(sellerid,id,updatedData)
