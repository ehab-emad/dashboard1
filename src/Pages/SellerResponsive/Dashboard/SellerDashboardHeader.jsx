...
import NotificationsWindowSeller from './Notificationes/NotificationsWindowSeller';
...
const SellerDashboardHeader = ({setCurrentPage,currentPage , toggleFunc}) => {
  ...
  useEffect(() => {
    ...
    dispatch(SellerNotifications(localStorage.getItem('sellerId')))
  ...
  return (
    <header style={styles.dashboardHeader}>
      <div style={styles.actionButtons}>
        ...
        <AddProductButton    
      disabled={!isSellerApproved} // ✅ Disables if false
      onClick={isSellerApproved ? navigateToDashboard : undefined}
          tabIndex="0"
          style={{
            backgroundColor: isSellerApproved ? '#26969c' : '#cccccc',
            cursor: isSellerApproved ? 'pointer' : 'not-allowed',
            boxShadow: isSellerApproved ? '0px 4px 24px 0px rgba(0, 0, 0, 0.08)' : 'none'
          }}
          >
          <span>إضافة منتج</span>
          <img
            loading="lazy"
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/91d2c339c87c126d85152c68ecb3a85732eda28165495d993b4812cc764ed2ed?placeholderIfAbsent=true&apiKey=2e2b2f636cc34221b980cbf747a16fe6"
        ...
        <div style={styles.notificationIcons}>
            ...
            />
              <div
              loading="lazy"
              style={styles.counticon}> {seller_notification.length} </div>

        </div>

        {Notifications   ? <NotificationsWindowSeller close={toggleNotifications} setCurrentPage={setCurrentPage} notifications={notifications} /> : null }
